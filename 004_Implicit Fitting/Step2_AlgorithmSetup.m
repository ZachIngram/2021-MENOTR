...
Amp = 3;                  % Initial guess
Amp_ub = 20;            % Upper bound
Amp_lb = 0.01;            % Lower bound
...
param_vals = [Amp K1 K2];
params_ub = [Amp_ub K1_ub K2_ub];
params_lb = [Amp_lb K1_lb K2_lb];
clear Amp K1 K2 Amp_ub K1_ub K2_ub Amp_lb K1_lb K2_lb
...
Amp_c(1) = 1;   % Amp_c(1) : Amp is the parameter name, _c indicates the cycles 
...
CyMat=[Amp_c; K1_c; K2_c;NLLS]';
CyMatH=size(CyMat,1);
clear Amp_c K1_c K2_c NLLS_c
...
%% Section 3: RUN FIGURE SETTINGS
    ...
    run_fig = 'on';
    % Axspace
        % Choose whether the data dsiplayed in the run figure is on a
...
% GA SETTINGS:
    ...
    % Mut_probability
        ...
        % mut_probability. The corrolary is that the probability of the
