...
% initializes the fit settings and sets up the data an d initial guesses. ALL
...
%% Section 1: PARAMETER GUESSES***
    ...
    % point. The genetic algorithm (GA) portion of the algorithm will help reduce how sensitive
    ...
    % bounds have to be different values. 
 
 
m = 5;                  % Initial guess
m_ub = 1000;            % Upper bound
m_lb = 0.01;            % Lower bound
...
m_c(1) = 1;   % m_c(1) : m is the parameter name, _c indicates the cycles 
