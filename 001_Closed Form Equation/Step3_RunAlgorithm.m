...
%% PARPOOL SETUP
% indexes number of available cores and sets up parallel %calculations, this is only needed when PC has more cores than matlab % will use by default
%     delete(gcp('nocreate'))
...
Sim_Fits = model_simulator(param_vals_fit,indvar1_sim);
